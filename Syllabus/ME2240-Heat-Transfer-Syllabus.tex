...
&Office hours: T 10:00-11:30, W 12:30-2:00 Votey 201A or by appointment\\%
&&\\%
TA(s)& TBA \\
&Office hours: TBAS\\%
&&\\%
...
\item Project grade $P$ is a function of two small project $P_1$, $P_2$ and one final project $P_f$: $P=(\min(P_1,P_2)+2\max(P_1,P_2)+4P_f)/7$
\end{itemize}

The final grade is 
\begin{equation}
\mathrm{Final~grade}=0.25HW+0.35E+0.4P
\end{equation}
...
\item Office hours will be conducted in person or online upon request prior to the beginning of office hours via a message to the TA or instructor on Teams. 
\item You are encouraged to use the Teams channel to ask questions related to assignments, please tag the instructor in your message.
\item In any interaction, be courteous and productive.
\item Instructor and TA will do their very best to answer your question posted within 24 hours, Monday to Friday. 
\end{itemize}
